...
class PublisherDocument(Document):
    ...
    # Geo-shape fields
    location_point = fields.GeoShapeField(
        strategy="recursive", attr="location_point_indexing"
    )
    location_circle = fields.GeoShapeField(
        strategy="recursive", attr="location_circle_indexing"
    )
